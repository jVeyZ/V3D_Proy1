"""gesture_robot.py - Deteccion de gestos con MediaPipe para control del robot digital."""
...
class GestureRobotController:
    ...
    def _draw_overlay(self, frame_bgr, result):
        ...
        cv2.putText(out, "GESTURE: digital", (15, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        return out
